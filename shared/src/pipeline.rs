...
/// Command string with optional following operator
type CommandWithOperator = (String, Option<Operator>);
...
fn complete_command(
    current: &mut String,
    result: &mut Vec<CommandWithOperator>,
...
fn split_by_operators(input: &str) -> Vec<CommandWithOperator> {
