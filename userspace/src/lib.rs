...
pub use programs_extra::{
    cat_main_loop, chmod_main_loop, cp_main_loop, cut_main_loop, diff_main_loop, find_main_loop,
    grep_main_loop, head_main_loop, mkdir_main_loop, mv_main_loop, rm_main_loop, sed_main_loop,
    sort_main_loop, tail_main_loop, uniq_main_loop, wc_main_loop, Cat, Chmod, Cp, Cut, Diff,
    Find, Grep, Head, Mkdir, Mv, Rm, Sed, Sort, Tail, Uniq, Wc,
};
